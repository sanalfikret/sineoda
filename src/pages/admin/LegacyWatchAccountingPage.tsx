...
export function LegacyWatchAccountingPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Önceki izlenme raporları</h1>
        <p className="mt-1 text-sm text-plooy-muted">
          Eski sistemin kayıtları; 48 saat / IP doğrulaması içermez.
        </p>
      </div>

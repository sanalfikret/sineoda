/** Çekim İçin Notlar — ana bölüm ve alt kategori satırları */
export const CEKIM_NOTLARI_SECTION_TITLE = 'Çekim İçin Notlar'
export const CEKIM_NOTLARI_NAV_LABEL = 'Çekim Notları'
